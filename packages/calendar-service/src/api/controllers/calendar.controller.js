...
exports.getWeekCourses = async (req, res, next) => {
  try {
    const response = await CallApiService.getWeekCourses(
      req.params.calendarId,
      parseInt(req.params.nextWeek)
    )
    res.status(httpStatus.OK).json(response)
  } catch (e) {
    next(e)
...
exports.getDayCourses = async (req, res, next) => {
  try {
    const response = await CallApiService.getDayCourses(
      req.params.calendarId,
      parseInt(req.params.nextDay)
    )
    res.status(httpStatus.OK).json(response)
  } catch (e) {
    next(e)
...
exports.getCoursById = async (req, res, next) => {
  try {
    const response = await CallApiService.getCoursById(
      req.params.calendarId,
      req.params.idCours
    )
    res.status(httpStatus.OK).json(response)
